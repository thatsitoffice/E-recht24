...
import { WizardStepA } from './wizard/step-a';
import { WizardStepB } from './wizard/step-b';
import { WizardStepC } from './wizard/step-c';
import { WizardStepD } from './wizard/step-d';
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div>
            ...
            {currentStep === 'preview' && generatedDocument && (
              <DocumentPreview document={generatedDocument} client:load />
            )}
